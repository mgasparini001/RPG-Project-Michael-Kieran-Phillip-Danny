...
bartender::bartender(int treeSize) : talkingNPC(treeSize)
{
	...
	dialogueNode* n4 = new dialogueNode("It is said that the Goblin King has a great treasure horde that would make a man rich, but he keeps it hidden away in those caves so that no one can find it. There's also supposed to be an nicent armory near the entrance of the caves. If I was you, I would go see if I could get myself some weapons and fight the goblins good and proper. Who knows, you may even find some treasure!", "Press enter to continue", choices4);
	...
	dialogueNode* n6 = new dialogueNode("Oh no! Not this band of ruffians again! Their leader does not seem to like you and that punch from him seemed to hurt, are you just going to take that?", "0) I could do this all day (Start fight WIP)\n1) You're on your own! (Run away)\n2) You are all beneath me! (Start Fight WIP)\n3) Whatever he can punch me again (turn the other cheek)", choices6);
	dialogueTree.at(5) = n6;
	dialogueNode* n7 = new dialogueNode("The leader ruffed you up pretty good, but this should help you get back on you feet. Here take this gold coin as well for your trouble.", "Press enter to continue", choices7);
	dialogueTree.at(6) = n7;
	dialogueNode* n8 = new dialogueNode("Please defeat this guy!", "Press enter to continue", choices8);
